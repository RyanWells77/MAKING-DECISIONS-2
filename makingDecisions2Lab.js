...
//   if (nums[i] % 2 === 0)
//     evensArr = nums.push(i, 1)
//   // else {
//   //     nums.splice(i, 1)

//     console.log("Even Numbers", evensArr)
//     console.log("-----------------")
...
// testing the splice command
// let test2 = []

// let test = [1, 5, 9]
// console.log(test)

// test2 = test.splice(1, 2)

// console.log(test2)

  // console.log(evensArr, "Even Numbers")
  // console.log(nums, "Odd Numbers")
...
// Subscripting (accessing values using their index) an array can fail. What happens if you subscript
// to the 7th element, but there are not 7 elements in the array? Let's write some code to check for that. 
...
if (myFavoriteNumbers.length < 7){
  // console.log("Ther are not enough elemnts in this array.")
}
  else{
...
switch (letterGrade){
  case "A":
    console.log("The studentis doing excellenty.")
    break;
    case "B":
...
/* The famous FizzBuzz, Devmountain style!
  Create a for loop that iterates from 1 to 100. In this for loop, using some conditional logic,
   ...
   If the number is divisible by 5, console.log 'mountain'. If the number is divisible by 5 & 3, console.log 
  'Devmountain'. If the number is not divisible by 5 or 3, console.log the number itself.
